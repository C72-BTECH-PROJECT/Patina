...
import { Zap, Shield, TrendingUp, CheckCircle, AlertCircle, Star, Award, ChevronRight, Activity, Target, Code, FolderOpen, MapPin, Briefcase, Mail, Phone } from 'lucide-react';
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-3 mb-4">
                    {candidate?.github && (
                      <a href={candidate.github.startsWith('http') ? candidate.github : `https://${candidate.github}`} target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent-purple/20 transition-colors">
                        <Github className="w-4 h-4 text-white/70" />
                      </a>
                    )}
                    {candidate?.linkedin && (
                      <a href={candidate.linkedin.startsWith('http') ? candidate.linkedin : `https://${candidate.linkedin}`} target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent-cyan/20 transition-colors">
